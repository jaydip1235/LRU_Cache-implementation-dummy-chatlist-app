...
//dummy names :)
const chat_names = ["Bill Gates","Elon Musk","Jeff Bezos","Sundar Pichai","Satya Nadella","Steve Jobs","Mark Zuckerberg"];
const chat_names_length = chat_names.length;

//dummy text messages
const chat_msg = ["Hey , how is your business going , th...",
    "Perfect, I am really glad to hear that!...",
    "The stock market is going to ri...",
...
class ChatHandler{
    ...
    constructor(chat_template, chat_list){
        ...
        //this.linked list denotes the head of the linked list
    ...
    getTime(){
        // Time Stamp for creation for messages
        //randomly adds 1 min to the current msg time
        this.mins += 1;
        if(this.mins === 60){
            this.hours += 1;
            this.mins = 0;
